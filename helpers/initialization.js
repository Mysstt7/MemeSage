 ...
 * including the V1 router and factory, and also 
 * initializing the `MemeHunter.sol` contract.
 */
...
// Import the MemeHunter contract ABI
const IArbitrage = require('../artifacts/contracts/MemeHunter.sol/MemeHunter.json');

// Create an instance of the MemeHunter contract
const MemeHunter = new hre.ethers.Contract(config.PROJECT_SETTINGS.ARBITRAGE_ADDRESS, IArbitrage.abi, provider);
